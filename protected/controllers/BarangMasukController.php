...
class BarangMasukController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('kelola','delete','cetak'),
				'users'=>array('@'),
	...
	{
		$this->layout = "print";				
		$BMDetail=BarangMasukDetail::model()->getDetail($id);
	...
	{
		$BMDetail=BarangMasukDetail::model()->getDetail($id);
		$BMFDetail=new BarangMasukDetail;
		if(isset($_POST['BarangMasukDetail']))
		{
			$BMFDetail->attributes=$_POST['BarangMasukDetail'];
			$BMFDetail->incoming_code=$id;
			if($BMFDetail->save())
				$this->redirect(array('barangMasuk/view/id/'.$id));
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['BarangMasuk']))
		{
			$model->attributes=$_POST['BarangMasuk'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->incoming_code));
		}
